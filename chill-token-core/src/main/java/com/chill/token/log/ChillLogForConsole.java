...
package com.chill.token.log;

import com.chill.token.ChillManager;
import com.chill.token.config.ChillTokenConfig;
import com.chill.token.util.StrFormatter;

/**
 * Chill-Token 日志实现类 [ 控制台打印 ]
 *
 * @author chill
 * @since 1.0
 */
public class ChillLogForConsole implements ChillLog {
     ...
     * 日志输出的前缀
     */
    public static String LOG_PREFIX = "ChillLog -->: ";
    public static String TRACE_PREFIX = "CHILL-TOKEN [TRACE]-->: ";
    public static String DEBUG_PREFIX = "CHILL-TOKEN [DEBUG]-->: ";
    public static String INFO_PREFIX = "CHILL-TOKEN [INFO] -->: ";
    public static String WARN_PREFIX = "CHILL-TOKEN [WARN] -->: ";
    public static String ERROR_PREFIX = "CHILL-TOKEN [ERROR]-->: ";
    public static String FATAL_PREFIX = "CHILL-TOKEN [FATAL]-->: ";
    ...
    public void println(int level, String color, String prefix, String str, Object... args) {
        ChillTokenConfig config = ChillManager.getConfig();
