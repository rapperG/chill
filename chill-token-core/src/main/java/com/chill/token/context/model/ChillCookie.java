...
public class ChillCookie {
     ...
     * @param value 值
     */
    public ChillCookie(String name, String value) {
        this.name = name;
        this.value = value;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setValue(String value) {
        this.value = value;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setMaxAge(int maxAge) {
        this.maxAge = maxAge;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setDomain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setSecure(Boolean secure) {
        this.secure = secure;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookie setHttpOnly(Boolean httpOnly) {
     ...
     * @return 对象自身
     */
    public ChillCookie setSameSite(String sameSite) {
    ...
    public String toString() {
        return "ChillCookie [name=" + name + ", value=" + value + ", maxAge=" + maxAge + ", domain=" + domain + ", path=" + path
    ...
    public String toHeaderValue() {
        ...
        if (ChillFoxUtil.isEmpty(name)) {
            throw new TokenException("name不能为空").setCode(ChillErrorCode.CODE_12002);
        }
        if (value != null && value.contains(";")) {
            throw new TokenException("无效Value：" + value).setCode(ChillErrorCode.CODE_12003);
        }
        ...
        if (!ChillFoxUtil.isEmpty(domain)) {
            sb.append("; Domain=").append(domain);
        }
        if (!ChillFoxUtil.isEmpty(path)) {
        ...
        if (!ChillFoxUtil.isEmpty(sameSite)) {
