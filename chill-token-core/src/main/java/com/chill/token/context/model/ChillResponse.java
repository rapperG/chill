 ...
 * @since 1.0
 */
public interface ChillResponse {
    ...
    default void addCookie(String name, String value, String path, String domain, int timeout) {
        this.addCookie(new ChillCookie(name, value).setPath(path).setDomain(domain).setMaxAge(timeout));
    }
     ...
     */
    default void addCookie(ChillCookie cookie) {
        this.addHeader(ChillCookie.HEADER_NAME, cookie.toHeaderValue());
    }
     ...
     * @return 对象自身
     */
    ChillResponse setStatus(int sc);
     ...
     * @return 对象自身
     */
    ChillResponse setHeader(String name, String value);
     ...
     * @return 对象自身
     */
    ChillResponse addHeader(String name, String value);
     ...
     * @return 对象自身
     */
    default ChillResponse setServer(String value) {
