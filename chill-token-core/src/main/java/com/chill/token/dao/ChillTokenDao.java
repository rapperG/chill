 ...
 * @since 1.0
 */
public interface ChillTokenDao {
    ...
    // --------------------- ChillSession 读写 （默认复用 Object 读写方法） ---------------------

    /**
     * 获取 ChillSession，如无返空
     *
     * @param sessionId sessionId
     * @return ChillSession
     */
    default ChillSession getSession(String sessionId) {
        return (ChillSession) getObject(sessionId);
    }

    /**
     * 写入 ChillSession，并设定存活时间（单位: 秒）
     *
     * @param session 要保存的 ChillSession 对象
     * @param timeout 过期时间（单位: 秒）
     */
    default void setSession(ChillSession session, long timeout) {
     ...
     * 更新 ChillSession
     *
     * @param session 要更新的 ChillSession 对象
     */
    default void updateSession(ChillSession session) {
    ...
    /**
     * 获取 ChillSession 剩余存活时间（单位: 秒）
     *
     * @param sessionId 指定 ChillSession
     * @return 这个 ChillSession 的剩余存活时间
     */
