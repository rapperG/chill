...
/**
 * 在调用 `AuthLoginUtil.login()` 时的 配置参数 Model，决定登录的一些细节行为 <br>
 *
 * <pre>
...
public class ChillLoginModel {
     ...
     * @return 对象自身
     */
    public ChillLoginModel setDevice(String device) {
        this.device = device;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillLoginModel setIsLastingCookie(Boolean isLastingCookie) {
     ...
     * @return 对象自身
     */
    public ChillLoginModel setTimeout(long timeout) {
     ...
     * @return 对象自身
     */
    public ChillLoginModel setActiveTimeout(long activeTimeout) {
     ...
     * @return 对象自身
     */
    public ChillLoginModel setExtraData(Map<String, Object> extraData) {
     ...
     * @return 对象自身
     */
    public ChillLoginModel setToken(String token) {
        this.token = token;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillLoginModel setIsWriteHeader(Boolean isWriteHeader) {
        this.isWriteHeader = isWriteHeader;
        return this;
    }

    /**
     * 获取 本次登录挂载到 ChillTokenSign 的数据
     *
     * @return tokenSignTag 本次登录挂载到 ChillTokenSign 的数据
     */
     ...
     *
     * @param tokenSignTag 本次登录挂载到 ChillTokenSign 的数据
     * @return 对象自身
     */
    public ChillLoginModel setTokenSignTag(Object tokenSignTag) {
    ...
    public Long getTimeoutOrGlobalConfig() {
        if (timeout == null) {
            timeout = ChillManager.getConfig().getTimeout();
        }
        return timeout;
    }
    ...
    public Boolean getIsWriteHeaderOrGlobalConfig() {
        if (isWriteHeader == null) {
            isWriteHeader = ChillManager.getConfig().getIsWriteHeader();
        }
        return isWriteHeader;
    }
     ...
     * @return 对象自身
     */
    public ChillLoginModel setExtra(String key, Object value) {
    ...
    public int getCookieTimeout() {
        ...
        if (getTimeoutOrGlobalConfig() == ChillTokenDao.NEVER_EXPIRE) {
    ...
    public String getDeviceOrDefault() {
        if (device == null) {
            return ChillTokenConstants.DEFAULT_LOGIN_DEVICE;
        }
        return device;
    }
     ...
     * @return 对象自身
     */
    public ChillLoginModel build() {
        return build(ChillManager.getConfig());
    }
     ...
     * @return 对象自身
     */
    public ChillLoginModel build(ChillTokenConfig config) {
//		if(device == null) {
//			device = ChillTokenConstants.DEFAULT_LOGIN_DEVICE;
//		}
//		if(isLastingCookie == null) {
