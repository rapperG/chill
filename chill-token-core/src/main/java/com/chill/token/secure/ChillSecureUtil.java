...
package com.chill.token.secure;
...
/**
 * Chill-Token 常见加密算法工具类
 *
 * @author chill
 * @since 1.0
 */
public class ChillSecureUtil {

    private ChillSecureUtil() {
    }
    ...
    public static String md5(String str) {
        ...
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12111);
        }
    }
    ...
    public static String sha1(String str) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12112);
        }
    }
    ...
    public static String sha256(String str) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12113);
        }
    }
    ...
    public static String aesEncrypt(String key, String text) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12114);
        }
    }
    ...
    public static String aesDecrypt(String key, String text) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12115);
        }
    }
    ...
    public static String rsaEncryptByPublic(String publicKeyString, String content) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12116);
        }
    }
    ...
    public static String rsaEncryptByPrivate(String privateKeyString, String content) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12117);
        }
    }
    ...
    public static String rsaDecryptByPublic(String publicKeyString, String content) {
        ...
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12118);
        }
    }
    ...
    public static String rsaDecryptByPrivate(String privateKeyString, String content) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12119);
        }
    }
