 ...
 * <p>
 * 在 Chill-Token 中，ChillSession 分为三种，分别是：	<br>
 * - Account-Session: 指的是框架为每个 账号id 分配的 ChillSession。	<br>
 * - Token-Session: 指的是框架为每个 token 分配的 ChillSession。	<br>
 * - Custom-Session: 指的是以一个 特定的值 作为SessionId，来分配的 ChillSession。	<br>
 * <br>
 ...
 * @since 1.0
 */
public class ChillSession implements ChillSetValueInterface, Serializable {
    ...
    /**
     * 在 ChillSession 上存储用户对象时建议使用的 key
     */
    public static final String USER = "USER";

    /**
     * 在 ChillSession 上存储角色列表时建议使用的 key
     */
    public static final String ROLE_LIST = "ROLE_LIST";

    /**
     * 在 ChillSession 上存储权限列表时建议使用的 key
     */
    ...
    /**
     * 所属 loginId （当此 ChillSession 属于 Account-Session 时，此值有效）
     */
    private Object loginId;

    /**
     * 所属 Token （当此 ChillSession 属于 Token-Session 时，此值有效）
     */
    private String token;

    /**
     * 此 ChillSession 的创建时间（13位时间戳）
     */
     ...
     * @param id Session的id
     */
    public ChillSession(String id) {
        this.id = id;
        this.createTime = System.currentTimeMillis();
        // $$ 发布事件
        ChillTokenEventCenter.doCreateSession(id);
    }

    /**
     * 获取：此 ChillSession 的 id
     *
     * @return /
     */
    public String getId() {
    ...
    /**
     * 写入：此 ChillSession 的 id
     *
     * @param id /
     * @return 对象自身
     */
    public ChillSession setId(String id) {
        this.id = id;
        return this;
    }

    /**
     * 获取：此 ChillSession 的 类型
     *
     * @return /
     */
    ...
    /**
     * 设置：此 ChillSession 的 类型
     *
     * @param type /
     * @return 对象自身
     */
    public ChillSession setType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillSession setLoginType(String loginType) {
        this.loginType = loginType;
        return this;
    }

    /**
     * 获取：所属 loginId （当此 ChillSession 属于 Account-Session 时，此值有效）
     *
     * @return /
     */
    ...
    /**
     * 设置：所属 loginId （当此 ChillSession 属于 Account-Session 时，此值有效）
     *
     * @param loginId /
     * @return 对象自身
     */
    public ChillSession setLoginId(Object loginId) {
        this.loginId = loginId;
        return this;
    }

    /**
     * 获取：所属 Token （当此 ChillSession 属于 Token-Session 时，此值有效）
     *
     * @return /
     */
    ...
    /**
     * 设置：所属 Token （当此 ChillSession 属于 Token-Session 时，此值有效）
     *
     * @param token /
     * @return 对象自身
     */
    public ChillSession setToken(String token) {
        this.token = token;
        return this;
    }

    /**
     * 返回：当前 ChillSession 的创建时间（13位时间戳）
     *
     * @return /
     */
    ...
    /**
     * 写入：此 ChillSession 的创建时间（13位时间戳）
     *
     * @param createTime /
     * @return 对象自身
     */
    public ChillSession setCreateTime(long createTime) {
     ...
     */
    public void addTokenSign(ChillTokenSign tokenSign) {
    ...
    public void addTokenSign(String tokenValue, String device) {
        addTokenSign(new ChillTokenSign(tokenValue, device, null));
    }
     ...
     */
    public void update() {
        ChillManager.getChillTokenDao().updateSession(this);
    }
     ...
     */
    public void logout() {
        ChillManager.getChillTokenDao().deleteSession(this.id);
        // $$ 发布事件
        ChillTokenEventCenter.doLogoutSession(id);
    }
    ...
    public long getTimeout() {
        return ChillManager.getChillTokenDao().getSessionTimeout(this.id);
    }
    ...
    public void updateTimeout(long timeout) {
        ChillManager.getChillTokenDao().updateSessionTimeout(this.id, timeout);
    }
    ...
    protected long trans(long value) {
        return value == ChillTokenDao.NEVER_EXPIRE ? Long.MAX_VALUE : value;
    }
     ...
     */
    @Override
    public ChillSession set(String key, Object value) {
     ...
     */
    @Override
    public ChillSession setByNull(String key, Object value) {
        if (!has(key)) {
            dataMap.put(key, value);
            update();
        }
     ...
     */
    @Override
    public ChillSession delete(String key) {
        dataMap.remove(key);
        update();
        return this;
    }
     ...
     */
    @Deprecated
    public List<ChillTokenSign> tokenSignListCopyByDevice(String device) {
