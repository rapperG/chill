 ...
 * @since 1.0
 */
public class ChillTokenConstants {

    private ChillTokenConstants() {
    }
     ...
     * Chill-Token 当前版本号
     */
    public static final String VERSION_NO = "v1.0.RC";

    /**
     * Chill-Token 开源地址 Gitee
     */
    public static final String GITEE_URL = "https://gitee.com/dromara/Chill-Token";

    /**
     * Chill-Token 开源地址 GitHub
     */
    public static final String GITHUB_URL = "https://github.com/dromara/Chill-Token";

    /**
     * Chill-Token 开发文档地址
     */
    public static final String DEV_DOC_URL = "https://Chill-Token.cc";
