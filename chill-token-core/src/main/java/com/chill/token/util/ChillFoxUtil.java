 ...
 * @since 1.0
 */
public class ChillFoxUtil {

    private ChillFoxUtil() {
    }

    /**
     * 打印 Chill-Token 版本字符画
     */
    public static void printSaToken() {

        System.out.println(" ------------------------------------------- chill token");
    }
    ...
    public static String encodeUrl(String url) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12103);
        }
    }
    ...
    public static String decoderUrl(String url) {
        try {
            ...
            throw new TokenException(e).setCode(ChillErrorCode.CODE_12104);
        }
    }
