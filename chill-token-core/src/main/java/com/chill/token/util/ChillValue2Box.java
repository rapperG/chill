...
public class ChillValue2Box {
     ...
     * @param value2 第二个值
     */
    public ChillValue2Box(Object value1, Object value2) {
        this.value1 = value1;
        this.value2 = value2;
    }
     ...
     */
    public ChillValue2Box(String valueString) {
        if (valueString == null) {
            return;
        }
    ...
    public boolean value1IsEmpty() {
        return ChillFoxUtil.isEmpty(value1);
    }
    ...
    public boolean value2IsEmpty() {
        return ChillFoxUtil.isEmpty(value2);
    }
     ...
     * <br><br>
     * <pre>
     *     System.out.println(new ChillValue2Box(1, 2));     // 1,2
     *     System.out.println(new ChillValue2Box(null, null));   // null
     *     System.out.println(new ChillValue2Box(1, null));   // 1
     *     System.out.println(new ChillValue2Box(null, 2));  // ,2
     * </pre>
     *
     * @return /
     */
