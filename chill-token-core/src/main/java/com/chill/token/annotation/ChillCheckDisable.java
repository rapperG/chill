...
public @interface ChillCheckDisable {
     ...
     * @return /
     */
    String[] value() default {ChillTokenConstants.DEFAULT_DISABLE_SERVICE};
     ...
     * @return /
     */
    int level() default ChillTokenConstants.DEFAULT_DISABLE_LEVEL;
