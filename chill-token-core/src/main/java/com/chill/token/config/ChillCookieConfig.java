...
/**
 * Chill-Token Cookie写入 相关配置
 *
 * @author chill
 * @since 1.0
 */
public class ChillCookieConfig {
     ...
     * @return 对象自身
     */
    public ChillCookieConfig setDomain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookieConfig setPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookieConfig setSecure(Boolean secure) {
        this.secure = secure;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillCookieConfig setHttpOnly(Boolean httpOnly) {
     ...
     * @return 对象自身
     */
    public ChillCookieConfig setSameSite(String sameSite) {
    ...
    public String toString() {
        return "ChillCookieConfig [domain=" + domain + ", path=" + path + ", secure=" + secure + ", httpOnly=" + httpOnly
            + ", sameSite=" + sameSite + "]";
    }
