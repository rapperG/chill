 ...
 * @since 1.0
 */
public class ChillTokenConfig implements Serializable {
     ...
     * Cookie配置对象
     */
    public ChillCookieConfig cookie = new ChillCookieConfig();

    /**
     * API 签名配置对象
     */
    public ChillSignConfig sign = new ChillSignConfig();
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setTokenName(String tokenName) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setTimeout(long timeout) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setActiveTimeout(long activeTimeout) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setDynamicActiveTimeout(Boolean dynamicActiveTimeout) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsConcurrent(Boolean isConcurrent) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsShare(Boolean isShare) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setMaxLoginCount(int maxLoginCount) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setMaxTryTimes(int maxTryTimes) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsReadBody(Boolean isReadBody) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsReadHeader(Boolean isReadHeader) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsReadCookie(Boolean isReadCookie) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsWriteHeader(Boolean isWriteHeader) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setTokenStyle(String tokenStyle) {
        this.tokenStyle = tokenStyle;
        return this;
    }

    /**
     * @return 默认 ChillTokenDao 实现类中，每次清理过期数据间隔的时间（单位: 秒），默认值30秒，设置为 -1 代表不启动定时清理
     */
    ...
    /**
     * @param dataRefreshPeriod 默认 ChillTokenDao 实现类中，每次清理过期数据间隔的时间（单位: 秒），默认值30秒，设置为 -1 代表不启动定时清理
     * @return 对象自身
     */
    public ChillTokenConfig setDataRefreshPeriod(int dataRefreshPeriod) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setTokenSessionCheckLogin(Boolean tokenSessionCheckLogin) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setAutoRenew(Boolean autoRenew) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setTokenPrefix(String tokenPrefix) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsPrint(Boolean isPrint) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsLog(Boolean isLog) {
        this.isLog = isLog;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setLogLevel(String logLevel) {
        this.logLevel = logLevel;
        this.logLevelInt = ChillFoxUtil.translateLogLevelToInt(logLevel);
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setLogLevelInt(int logLevelInt) {
        this.logLevelInt = logLevelInt;
        this.logLevel = ChillFoxUtil.translateLogLevelToString(logLevelInt);
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setIsColorLog(Boolean isColorLog) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setJwtSecretKey(String jwtSecretKey) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setBasic(String basic) {
        this.basic = basic;
        return this;
    }
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setCurrDomain(String currDomain) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setSameTokenTimeout(long sameTokenTimeout) {
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setCheckSameToken(Boolean checkSameToken) {
     ...
     */
    public ChillCookieConfig getCookie() {
        return cookie;
    }
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setCookie(ChillCookieConfig cookie) {
        this.cookie = cookie;
        return this;
    }
     ...
     * @return API 签名全局配置对象
     */
    public ChillSignConfig getSign() {
        return sign;
    }
     ...
     * @return 对象自身
     */
    public ChillTokenConfig setSign(ChillSignConfig sign) {
        this.sign = sign;
        return this;
    }
    ...
    public long getActivityTimeout() {
        System.err.println("配置项已过期，请更换：Chill-Token.activity-timeout -> Chill-Token.active-timeout");
        return activeTimeout;
    }
     ...
     */
    @Deprecated
    public ChillTokenConfig setActivityTimeout(long activityTimeout) {
        System.err.println("配置项已过期，请更换：Chill-Token.activity-timeout -> Chill-Token.active-timeout");
