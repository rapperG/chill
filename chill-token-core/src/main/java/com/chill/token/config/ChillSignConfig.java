...
/**
 * Chill-Token API 接口签名/验签 相关配置类
 *
 * @author chill
 * @since 1.0
 */
public class ChillSignConfig {
     ...
     * @return 对象自身
     */
    public ChillSignConfig setSecretKey(String secretKey) {
     ...
     * @return 对象自身
     */
    public ChillSignConfig setTimestampDisparity(long timestampDisparity) {
     ...
     * @return 对象自身
     */
    public ChillSignConfig setIsCheckNonce(Boolean isCheckNonce) {
